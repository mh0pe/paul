...
<references>
@${CLAUDE_PLUGIN_ROOT}/paul-framework/references/loop-phases.md
@${CLAUDE_PLUGIN_ROOT}/paul-framework/templates/SUMMARY.md
@${CLAUDE_PLUGIN_ROOT}/paul-framework/workflows/transition-phase.md (loaded when last plan in phase)
</references>
...
2. **MUST read and execute:** @${CLAUDE_PLUGIN_ROOT}/paul-framework/workflows/transition-phase.md
